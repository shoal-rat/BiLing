...
| Fuzzy pinyin (z/zh, n/ng, …) | — | **not yet implemented** |
| Typing-error edges | — | **not yet implemented** |
...
| 3 Hybrid lattice | character and name edges done; fuzzy, typo, entity edges not started |
