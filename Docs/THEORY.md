...
|---|---|---|---|---|---|
| 仅词典 | 29.8% | 40.8% | 44.6% | 0.347 | 4.7 ms |
| **完整系统** | **36.6%** | 43.2% | 44.6% | **0.393** | 46.8 ms |

差距是巨大的：同一套系统，作者语料 86.1%，推导语料 36.6%。**作者语料高估
了一倍以上。** 这是本报告最重要的一条结论，也是任何只在自建示例上验证的
输入法工作都应当自查的。

**覆盖率是天花板，不是排序。** 完整系统 36.6% 对覆盖率 44.6%——凡是候选
里存在正确答案的，82% 已经排在第一。也就是说打分已经相当好，失败几乎全部
